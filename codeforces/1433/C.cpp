...
void solve(){
    ...
    cin>>arr;
    //cout<<arr<<endl;
    auto ma=max_element(all(arr));
    if(count(all(arr),*ma)!=n){
        for(ll i=0;i<n;i++){
            if(i==0&&arr[i]==*ma&&arr[i]>arr[i+1]){
                cout<<i+1<<endl;
                break;
                //return;
            }else if(i==n-1&&arr[i]==*ma&&arr[i]>arr[i-1]){
                cout<<n<<endl;
                break;
                //return;
            }else if(i!=0&&i!=n&&arr[i]==*ma&&(arr[i]>arr[i+1]||arr[i]>arr[i-1])){
                cout<<i+1<<endl;
                break;
                //return;
            }
